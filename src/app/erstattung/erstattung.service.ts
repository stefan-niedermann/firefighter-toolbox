...
export class ErstattungService {
  ...
  public generateFax(value: any): ArrayBuffer[] {
    ...
    return value.personal.map((person: any) => {
      ...
      doc.text(`${value.allgemeines.ort || value.allgemeines.wehr || '________________'}, ${this.datePipe.transform(new Date(), 'mediumDate')}`, this.paddingLeft, this.paddingTop + 229.6)
